From Fairness Require Import dfrac agree updates local_updates cmra.
From Fairness Require Import proofmode_classes.
From iris.prelude Require Import prelude options.

Local Open Scope iris_algebra_scope.

Definition dfrac_agreeR (A : Type) : cmra := prodR dfracR (agreeR A).

Definition to_dfrac_agree {A : Type} (d : dfrac) (a : A) : dfrac_agreeR A :=
  (d, to_agree a).
...
Definition to_frac_agree {A : Type} (q : Qp) (a : A) : dfrac_agreeR A :=
...
Section lemmas.
  ...
  Qed.
  Lemma dfrac_agree_op_valid_L d1 a1 d2 a2 :
    ✓ (to_dfrac_agree d1 a1 ⋅ to_dfrac_agree d2 a2) ↔
    ✓ (d1 ⋅ d2) ∧ a1 = a2.
  ...
  Lemma frac_agree_op_valid q1 a1 q2 a2 :
    ...
    (q1 + q2 ≤ 1)%Qp ∧ a1 = a2.
  Proof. apply dfrac_agree_op_valid. Qed.
  Lemma frac_agree_op_valid_L q1 a1 q2 a2 :
    ✓ (to_frac_agree q1 a1 ⋅ to_frac_agree q2 a2) ↔
    (q1 + q2 ≤ 1)%Qp ∧ a1 = a2.
  ...
  Lemma dfrac_agree_included_L d1 a1 d2 a2 :
    to_dfrac_agree d1 a1 ≼ to_dfrac_agree d2 a2 ↔
    (d1 ≼ d2) ∧ a1 = a2.
  Proof. apply dfrac_agree_included. Qed.

  Lemma frac_agree_included q1 a1 q2 a2 :
    to_frac_agree q1 a1 ≼ to_frac_agree q2 a2 ↔
    (q1 < q2)%Qp ∧ a1 = a2.
  Proof. by rewrite dfrac_agree_included dfrac_own_included. Qed.
  Lemma frac_agree_included_L q1 a1 q2 a2 :
    to_frac_agree q1 a1 ≼ to_frac_agree q2 a2 ↔
    (q1 < q2)%Qp ∧ a1 = a2.
